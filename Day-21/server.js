...
app.post('/login', async (req, res) => {
  try {
    ...
    const token = jwt.sign(
      { firstName: checkUser.firstName, lastName: checkUser.lastName, email: checkUser.email, role: checkUser.role },
...
app.get('/chat', checkAuth, (req, res) => {
  res.render('chat.ejs', { username: req.session.user });
});
...
app.get('/search-users', checkAuth, async (req, res) => {
