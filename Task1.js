...
console.log("////////////////////////////////////////////////////////////////////////////")
// 5) Log course material from classroom materials (use materials array from classroom object)
...
console.log(word.replace("Fun", "Awesome"));
console.log("////////////////////////////////////////////////////////////////////////////")
...
console.log(classroom.batches[0].students[0].name + " " + classroom.batches[0].students[0].scores[classroom.batches[0].students[0].scores.length - 1] +" "+ classroom.batches[0].students[0].name.includes("a"));
console.log(classroom.batches[0].students[1].name + " " + classroom.batches[0].students[1].scores[classroom.batches[0].students[1].scores.length - 1] +" "+ classroom.batches[0].students[1].name.includes("a"));
