...
//]
//console.log(data[data.length-1][data[data.length-1].length-1][data[0].length-1][data[0].length][data[0].length-1])
//console.log(data[4][1][1][2][1])]
//console.log('5'+50)
/*
let data = {
  "posts": [
...
//console.log(data.posts[data.posts.length - 1].userId);
...
let username = 'Hana';
let password = '1235';
rl.question('Enter your username: ', ( inputUsername) => {
